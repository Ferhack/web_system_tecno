                ...
                <div class="card-body">
                    <form method="POST" action="{{ url('/aporte')}}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-10">
                                <input type="date" name="fecha_inicio_pago" id="fecha_inicio_pago" class = "form-control" required>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-10">
                                <input type="number" name="porcentaje_mora" id="porcentaje_mora" class = "form-control" required>
                            </div>
                        </div>
                        <br/>
                        <div class="row mb-0">
