...
@section('content')
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ url('/egreso/' . $egreso->nro_egreso) }}" class="row g-3">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-10">
                                    <input type="text" name="detalle" id="detalle" class="form-control"
                                        placeholder="pago de servico basico de luz" required value="{{ $egreso->detalle }}">
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-10">
                                    <input type="number" name="monto" class="form-control" min="1" step="0.1"
                                        placeholder="1500.5" required value="{{ $egreso->monto }}">
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-10">
                                    <input type="text" name="actor_receptor" id="actor_receptor" class="form-control"
                                        placeholder="Empresa CRE" required value="{{ $egreso->actor_receptor }}">
                                </div>
                            </div>
                            <br />
    ...
    <div class="card-footer">
        <?php
        session_start();
        if (isset($_SESSION['egreso_view_edit'])) {
            $_SESSION['egreso_view_edit'] = $_SESSION['egreso_view_edit'] + 1;
        } else {
            $_SESSION['egreso_view_edit'] = 1;
        }
        $x = $_SESSION['egreso_view_edit'];
        ?>
    </div>
@endsection
