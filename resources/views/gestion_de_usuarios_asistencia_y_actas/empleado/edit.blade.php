...
@section('content')
    ...
    <div class="card-footer">
        <?php
        session_start();
        if (isset($_SESSION['empleado_edit_view'])) {
            $_SESSION['empleado_edit_view'] = $_SESSION['empleado_edit_view'] + 1;
        } else {
            $_SESSION['empleado_edit_view'] = 1;
        }
        $x = $_SESSION['empleado_edit_view'];
        ?>
    </div>
@endsection
