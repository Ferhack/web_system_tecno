...
@section('content')
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-10">
                                    <input type="number" name="monto" class="form-control" min="1" step="0.1"
                                        placeholder="1500.5" required value="{{ $ingreso->monto }}">
                                </div>
                            </div>
    ...
    <div class="card-footer">
        <?php
        session_start();
        if (isset($_SESSION['ingreso_view_edit'])) {
            $_SESSION['ingreso_view_edit'] = $_SESSION['ingreso_view_edit'] + 1;
        } else {
            $_SESSION['ingreso_view_edit'] = 1;
        }
        $x = $_SESSION['ingreso_view_edit'];
        ?>
    </div>
@endsection
