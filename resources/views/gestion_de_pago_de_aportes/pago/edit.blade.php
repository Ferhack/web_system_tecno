                ...
                <div class="card-body">
                    <form method="POST" action="{{ url('/pago/'.$pago->nro_pago) }}" class="row g-3">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-10">
                                <input type="text" name="empleado" id="empleado" class = "form-control" value="{{Auth::user()->nombre}}" disabled>    
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-10">
                                <input type="date" name="fecha_pago" id="fecha_pago" class = "form-control" value="{{$pago->fecha_pago}}" disabled>    
                            </div>
                        </div>
